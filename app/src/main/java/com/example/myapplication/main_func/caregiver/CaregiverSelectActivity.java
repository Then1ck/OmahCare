...
public class CaregiverSelectActivity extends AppCompatActivity {

    private RecyclerView caregiverRecyclerView;
    private CaregiverSelectAdapter caregiverAdapter;
    private List<CaregiverModel> caregiverList;
    private List<CaregiverModel> filteredList;
    ...
    private void loadCaregiversFromFirebase() {
        caregiverRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CaregiverSelectActivity.this, "Gagal memuat data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void filterCaregivers(String text) {
        ...
        if (text == null || text.trim().isEmpty()) {
            ...
            for (CaregiverModel caregiver : caregiverList) {
