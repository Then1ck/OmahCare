...
public class HomeCareSelectAdapter extends RecyclerView.Adapter<HomeCareSelectAdapter.ViewHolder> {
    ...
    public HomeCareSelectAdapter(Context context, List<HomeCareModel> caregiverList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        HomeCareModel caregiver = caregiverList.get(position);
        ...
        holder.btnPesan.setOnClickListener(v -> {
            Intent intent = new Intent(context, HomeCareDateActivity.class);
